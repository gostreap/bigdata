...
public class B_1_hadoop {
	...
	public static class Mapper_Ar_part1
	...
	public static class Reducer_Ar_part1
	...
	public static class Reducer_Ar
    extends Reducer<Text,Text,Text,Text> {
	...
	public static class Mapper_norm
    extends Mapper<Object, Text, Text,Text>{
	...
	public static class Reducer_norm
    extends Reducer<Text,Text,Text,Text> {
	...
	public static class Mapper_normalize
    extends Mapper<Object, Text, Text,Text>{
	...
	public static void Ar(Configuration conf, String input_path1,String input_path2, String output_path) throws IOException, ClassNotFoundException, InterruptedException {
	...
	public static void calculate_norm(Configuration conf, String input_path, String output_path) throws IOException, ClassNotFoundException, InterruptedException {
	...
	public static void normalize(Configuration conf, String input_path, String output_path) throws IOException, ClassNotFoundException, InterruptedException {
