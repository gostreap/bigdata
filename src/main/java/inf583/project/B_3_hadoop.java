...
public class B_3_hadoop {
	...
	public static class Mapper_Ar_twoSteps_part1 extends Mapper<Object, Text, Text, Text> {
	...
	public static class Reducer_Ar_twoSteps_part1 extends Reducer<Text, Text, Text, Text> {
		...
		public void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
			...
			/*
			 * else System.out.println("error on reducer: "+test_values);
			 */
		}
	}

	public static class Mapper_Ar_twoSteps_part2 extends Mapper<Object, Text, Text, Text> {
	...
	public static class Reducer_Ar_twoSteps_part2 extends Reducer<Text, Text, Text, Text> {
	...
	// using only one step
	public static class Mapper_Ar_OneStep extends Mapper<Object, Text, Text, Text> {
	...
	public static class Reducer_Ar_OneStep extends Reducer<Text, Text, Text, Text> {
	...
	public static void Ar_twoStep(Configuration conf, String input_path1, String input_path2, String output_path)
	...
	public static void Ar_OneStep(Configuration conf, String input_path1, String input_path2, String output_path)
			throws IOException, ClassNotFoundException, InterruptedException {
